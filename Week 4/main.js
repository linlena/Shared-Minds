...
function init3D() {
    ...
    let panotexture = new THREE.TextureLoader().load("jungle.jpeg");
...
function createNewText(data, firebaseKey) {
    ...
    img.onload = function () {
        ...
        let thisObject = { type: "image", firebaseKey: firebaseKey, threeID: mesh.uuid, position: posInWorld, canvas: canvas, mesh: mesh, texture: texture, img: img };
